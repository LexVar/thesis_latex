...
%The keys are stored encrypted and authenticated with a dedicated key, following the protocol described in Section \ref{chap:implementation:services:secure}.
