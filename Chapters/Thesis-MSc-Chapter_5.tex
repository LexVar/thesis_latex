...
% -----------------------------------------------------
\section{Communications}\label{chap:implementation:comms}
...
\section{Services}\label{chap:implementation:services}
...
% -----------------------------------------------------
\subsection{Authentication}\label{chap:implementation:services:authentication}
...
% 1. Comecei com CTR + MAC - descrever algoritmo do project report
%         - Explicar conclusões e pk das escolhas
% 2. foi possível cifrar dados até 18K com dois buffers iguais para input e output. Limite da RAM de 64KB
% 3. O core permite utilizar 1 buffer para os dois, permitiu duplicar o tamanho dos dados a cifrar, para 36K utilizando o mesmo buffer
% 4. Problema: placa não permite cifrar por blocos e cifra contínua
...
% A placa inclui multiplicação de pontos por escalares, o que permite gerar chaves com ECDH e computar a chave public a partir da chave privada. Para além de multiplicação a placa inclui adição de pontos.
% Para ser possível implementar assinaturas digitais com ECDSA, é necessário uma biblioteca de operações com big numbers. 48 bytes - chave privada
% Bibliotecas de big numbers ocupam imenso espaço de RAM, a que foi testada ocupa 54KB, ocupa quase a memória inteira e limita a quantidade de dados que é possível assinar a 1.5 KB, desligando todos os outros serviços implementados.

% -----------------
\subsection{Key Importation}\label{chap:implementation:services:key-import}
...
% -----------------
\subsection{Key Revocation}\label{chap:implementation:services:key-revocation}
