...
The asymmetric keys generated inside the device, and never exposed to the outside, make the generation of qualified \textbf{digital signatures} possible. These strong signatures can legally represent the entity.
