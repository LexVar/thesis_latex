...
\begin{figure}[h]
	...
	\subfigure[Encrypt and authenticate data with K1 key]{\label{fig:arch-encrypt}\includegraphics[width=0.9\textwidth]{./Images/arch-encrypt.png}}
	\subfigure[Decrypt data and verify authentication with K1 key]{\label{fig:arch-decrypt}\includegraphics[width=0.9\textwidth]{./Images/arch-decrypt.png}}
