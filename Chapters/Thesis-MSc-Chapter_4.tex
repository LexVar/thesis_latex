...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[Alice generates key]{\label{fig:arch-ecdh-alice}\includegraphics[width=0.8\textwidth]{./Images/arch-ecdh-alice.png}}
	\subfigure[Bob generates the same key]{\label{fig:arch-ecdh-bob}\includegraphics[width=0.8\textwidth]{./Images/arch-ecdh-bob.png}}
