...
This mode is comparable to \ac{OFB}, as it is also a stream cipher and the encryption operation is exactly the same as the decryption. %and an error affects only the respective bits.
...
Beyond actual systems, several protocols and HSM applications have been proposed.
