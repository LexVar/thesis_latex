...
\subsubsection*{Smartfusion2}%\label{chap:background:computing:smartfusion}
...
The key codes are protected by AES encryption and stored in a private section of the eNVM.
...
Not all services in the smartfusion2 board are DPA-resistant. ECC point multiplication, \ac{NRBG}, SRAM-PUF and KeyTree are.
